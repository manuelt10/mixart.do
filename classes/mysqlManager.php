...
class mysqlManager
{
	...
	private 	$database_name = 'jennyoel_mixart'; #the name of the database\
	private 	$user = 'jennyoel'; #user of the database
	private 	$password = 'rTN3jYqkl7#'; #password of the database
